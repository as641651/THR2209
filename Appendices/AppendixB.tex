...
\\
\begin{tabular}{| p{.05\textwidth} | p{.15\textwidth} | p{.05\textwidth}|}
\hline
...
\begin{figure}[h] 
\centering
\includegraphics[width=0.7\textwidth]{genre}
\caption{Genre}
 \label{fig:genre}
 \end{figure}
\FloatBarrier
\begin{figure}[h] 
\centering
\includegraphics[width=0.7\textwidth]{instruments}
\caption{Instruments}
...
\begin{figure}[h] 
\centering
\includegraphics[width=0.7\textwidth]{rhythm_pace}
...
\begin{figure}[h] 
\centering
\includegraphics[width=0.7\textwidth]{other_tags}
\caption{Other Tags}
 \label{fig:other}
 \end{figure}
\FloatBarrier
